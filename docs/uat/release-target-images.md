...
3. Confirm the GitHub release contains source, Node runtime, SPA tarball, Desktop Native source tarball, Desktop Native
   ...
   iOS native-source tarball, iOS Simulator app tarball, Android source tarball, Android native-source tarball,
   Android debug APK tarball, Android release APK tarball, Start9 source tarball, Umbrel package tarball, and
...
- The iOS source, native-source, and unsigned Simulator app artifacts are not complete native targets until signed
  device-installable packages and transfer UAT pass.
