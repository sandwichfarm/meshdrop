...
| 2026-07-06 | `260706-v2r-fix-meshdrop-fips-pollen-cross-device-di` | complete | FIPS/Pollen federation advertises `kind:20385` Nostr discovery; live relay kind-space check rejected `20384` and accepted `20385`; focused 30/30; `npm test` 259/259; e2e; Docker smoke; changed-code slop clean; live compose image `sha256:e844f1c7a68864f4020b2db38a9945f5bedd784536d1c0f8794df13b3dc3a071` published FIPS and Pollen events |
