...
| 2026-07-06 | `260706-nostr-label-peer-crypto` | complete | Relay route text renamed to Nostr; one-bubble same-npub grouping retains Instance/Nostr badges; Private disables and Unencrypted defaults when Web Crypto is unavailable; focused 29/29; `npm test` 252/252; e2e and Docker transfer smokes pass; localhost:3000 browser proof passes; slop scans still exit 1 on existing baseline warnings |
