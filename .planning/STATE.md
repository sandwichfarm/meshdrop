...
| 2026-07-05 | `260705-ida-ios-device-archive-proof` | complete | Unsigned generic `iphoneos` device archive builder, CI smoke, and release readback added; focused 17/17; `npm test` 206/206; diff/check; changed-code slop clean |
